...
@section('content')
    ...
    <div class="container">
        ...
        <div class="detail-value">{{ $ServicesCategory->title }}</div>

        <div class="detail-label">Title AR</div>
        <div class="detail-value">{{ $ServicesCategory->title_ar }}</div>

        <div class="detail-label">Description </div>
        <div class="detail-value">{{ $ServicesCategory->description }}</div>

        <div class="detail-label">Description AR</div>
        <div class="detail-value">{{ $ServicesCategory->description_ar }}</div>

        <div class="detail-label">ICON</div>
        <div class="media-container">
            <img src="{{ asset('storage/' . $ServicesCategory->icon) }}" alt="Service Category Icon" style="max-height: 200px;"> <!-- Responsive and bounded image height -->
        </div>
    </div>
@endsection
