...
@section('title', 'Show Event Category')
...
@section('content')
    ...
    <div class="container">
        ...
        <div class="detail-value">{{ $events_category->title }}</div>

        <div class="detail-label">Title AR</div>
        <div class="detail-value">{{ $events_category->title_ar }}</div>

        <div class="detail-label">ICON</div>
        <div class="media-container">
            <img src="{{ asset('storage/' . $events_category->icon) }}" alt="Service Category Icon" style="max-height: 200px;"> <!-- Responsive and bounded image height -->
        </div>
