<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-1 bg-gradient-dark" id="sidenav-main">
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="_blank">
            <img src="{{ \Illuminate\Support\Facades\URL::asset('assets/img/evento_logo.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('events-offers.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('event-requests.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('cancelled_bookings')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('organizers.index')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('organizer-requests.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('updatedOrganizerRequests')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('serviceProvider-requests.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('venues.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('service-providers.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('events-request-categories.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('services-categories.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('events-categories.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('interest.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('reels.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('promo_code.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('service_provider.review')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('event.review')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('venue.review')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('notification.index')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
